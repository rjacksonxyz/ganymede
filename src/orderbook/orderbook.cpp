...
int Orderbook::AddOrder(Order o)
{
...
OrderPointers::iterator Orderbook::HandleMarketOrder(Order &o)
{
...
OrderPointers::iterator Orderbook::HandleLimitOrder(Order &o)
{
  OrderPointers::iterator iterator;
  Side side = o.GetSide();
  if (side == Side::Bid)
...
bool Orderbook::CanMatchLimitOrders()
{
  ...
  auto &[askPrice, asks] = *ask_orders.rbegin();
...
void Orderbook::MatchMarketOrders(Order &market_bid_order,
...
void Orderbook::MatchMarketOrders(Order &market_ask_order,
